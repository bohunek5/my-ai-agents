...
class Prime_Slider_Loader {
	...
	/**
	 * @return \Elementor\Prime_Slider_Loader
	 */
	...
	public function register_site_scripts() {
		...
		// wp_enqueue_script( 'mThumbnailScroller', BDTPS_ASSETS_URL . 'js/jquery.mThumbnailScroller' . $suffix . '.js', ['jquery', 'elementor-frontend'], BDTPS_VER );

		//Thirdparty widgets
		// wp_register_script( 'multiscroll', BDTPS_ASSETS_URL . 'vendor/js/jquery.multiscroll' . $suffix . '.js', ['jquery'], '1.1.1', true );
	...
	public function register_site_styles() {
		...
		// wp_register_style( 'bdt-prime-slider-isolate', BDTPS_ASSETS_URL . 'css/ps-isolate' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-blog', BDTPS_ASSETS_URL . 'css/ps-blog' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-woocommerce', BDTPS_ASSETS_URL . 'css/ps-woocommerce' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-custom', BDTPS_ASSETS_URL . 'css/ps-custom' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-flogia', BDTPS_ASSETS_URL . 'css/ps-flogia' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-woostand', BDTPS_ASSETS_URL . 'css/ps-woostand' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-multiscroll', BDTPS_ASSETS_URL . 'css/ps-multiscroll' . $direction_suffix . '.css', [], BDTPS_VER );

		// //Skin
		// wp_register_style( 'bdt-prime-slider-skin-slide', BDTPS_ASSETS_URL . 'css/ps-slide' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-skin-crelly', BDTPS_ASSETS_URL . 'css/ps-crelly' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-skin-meteor', BDTPS_ASSETS_URL . 'css/ps-meteor' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-skin-coral', BDTPS_ASSETS_URL . 'css/ps-coral' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-skin-slice', BDTPS_ASSETS_URL . 'css/ps-slice' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-skin-locate', BDTPS_ASSETS_URL . 'css/ps-locate' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-skin-zinest', BDTPS_ASSETS_URL . 'css/ps-zinest' . $direction_suffix . '.css', [], BDTPS_VER );
		// wp_register_style( 'bdt-prime-slider-skin-folio', BDTPS_ASSETS_URL . 'css/ps-folio' . $direction_suffix . '.css', [], BDTPS_VER );
