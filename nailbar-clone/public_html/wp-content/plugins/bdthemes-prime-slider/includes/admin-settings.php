    ...
    protected function prime_slider_admin_settings()
    {
        ...
        if (bdt_ps()->is__premium_only()) {
            $settings_fields['prime_slider_active_modules'][] = [
                ...
                'default' => "on",
                'widget_type' => 'pro',
                'content_type' => 'custom static new',
                'demo_url' => 'https://primeslider.pro/elements-demo/custom/',
        ...
        if (bdt_ps()->is__premium_only()) {
            $settings_fields['prime_slider_active_modules'][] = [
                'name' => 'woostand',
                'label' => esc_html__('WooStand Base', 'bdthemes-prime-slider'),
                'type' => 'checkbox',
                'default' => "on",
                'widget_type' => 'pro',
                'content_type' => 'ecommerce new',
                'demo_url' => 'https://primeslider.pro/elements-demo/woostand/',
