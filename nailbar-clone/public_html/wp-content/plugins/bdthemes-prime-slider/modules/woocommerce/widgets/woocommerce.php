	...
	public function render_item_content($product) {
		...
		<div class="bdt-ps-slideshow-content-wrapper">
			...
			<?php if ( $settings['show_title'] ) : ?>
				<h2 class="bdt-ps-title" bdt-slideshow-parallax="y: 70,0,-100; opacity: 1,1,0"><?php the_title(); ?></h2>
			<?php endif; ?>
		...
		?>
			...
			<li class="bdt-slideshow-item elementor-repeater-item-<?php echo get_the_ID(); ?>">
				...
				<div class="bdt-ps-item-inner bdt-flex bdt-flex-middle" bdt-grid>
					...
					<div class="bdt-ps-wc-product-img" style="background-image: url('<?php echo esc_url($image_src); ?>')">
