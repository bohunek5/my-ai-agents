	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li a' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'show_navigation_dots' => ['yes'],
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li a' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'show_navigation_dots' => ['yes'],
				],
		...
		$this->add_group_control(
			...
			[
				'name'        => 'dots_border',
				'label'       => esc_html__('Border', 'bdthemes-element-pack'),
				'selector'    => '{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li a:hover, {{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li a:hover:before' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'show_navigation_dots' => ['yes'],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li a:hover' => 'border-color: {{VALUE}}',
				],
				'condition' => [
					'show_navigation_dots' => ['yes'],
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li.bdt-active a, {{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li.bdt-active a:before' => 'background-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-ps-dotnav li.bdt-active a' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'show_navigation_dots' => ['yes'],
					'navigation_style_type'  => 'style3',
	...
	public function render_navigation_arrows()
	{
		...
		?>
			...
			<?php if ($settings['show_navigation_arrows']) : ?>
				...
				<a <?php echo $this->get_render_attribute_string('prev_position'); ?> href="#" bdt-slideshow-item="previous">
				...
				<a <?php echo $this->get_render_attribute_string('next_position'); ?> href="#" bdt-slideshow-item="next">
	...
	public function render_navigation_dots()
	{
		...
		?>
			...
			<?php if ($settings['show_navigation_dots']) : ?>
				<ul <?php echo $this->get_render_attribute_string('dots-position'); ?>></ul>
			<?php endif; ?>
