...
class Skin_Coral extends Elementor_Skin_Base {
    ...
    public function render_navigation_arrows($slide_index) {
		...
		?>
            ...
            <div class="bdt-ps-thumbnav">
                ...
                while ( $wp_query->have_posts() ) {
                    ...
                    <li class="bdt-slide-counter" bdt-slideshow-item="<?php echo ($slide_index - 1); ?>" data-label="<?php echo str_pad($slide_index, 2, '0', STR_PAD_LEFT); ?>">
    ...
    public function render_navigation_dots() {
        ...
        <?php $slide_index = 1; global $post; $wp_query = $this->parent->query_posts();
	...
	public function render_scroll_button_text() {
		...
		?>
        <span bdt-scrollspy="cls: bdt-animation-slide-right; repeat: true" <?php echo $this->parent->get_render_attribute_string('content-wrapper'); ?>>
    ...
    public function render_footer() {
        ?>
                ...
                <?php $this->render_navigation_arrows('$slide_index'); ?>
