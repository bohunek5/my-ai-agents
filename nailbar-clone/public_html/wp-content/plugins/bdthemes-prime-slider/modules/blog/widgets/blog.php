...
class Blog extends Widget_Base {
	...
	public function _register_skins() {
        ...
        if ( bdt_ps()->is__premium_only() ) {
            ...
            if ( 'on' == $folio or 'on' == $coral or 'on' == $zinest  and  bdt_ps()->is__premium_only() ) {
                if ('on' == $coral) {
	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider .bdt-prime-slider-desc .bdt-main-title h1 a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => ['yes'],
				],
		...
		if ( $this->get_skins() ) {
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .bdt-prime-slider .bdt-prime-slider-desc .bdt-main-title h1 a span' => 'color: {{VALUE}};',
					],
					'condition' => [
						'_skin' => ['coral'],
					],
	...
	public function render_menu($skin_name = 'blog', $menu_align = 'bdt-navbar-right') {
		$settings = $this->get_settings_for_display();
		?>
		...
		<?php if ( 'yes' == $settings['show_button_text'] ) : ?>
			...
			<a <?php echo $this->get_render_attribute_string('slider-button'); ?>>
				...
				<span <?php echo $this->get_render_attribute_string('content-wrapper'); ?>>
					...
					<span <?php echo $this->get_render_attribute_string('text'); ?>><?php echo esc_html($settings['button_text']); ?><span class="bdt-slide-btn-icon"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="arrow-right"><polyline fill="none" stroke="#000" points="10 5 15 9.5 10 14"></polyline><line fill="none" stroke="#000" x1="4" y1="9.5" x2="15" y2="9.5"></line></svg></span></span>
							...
							<div class="bdt-width-1-1 bdt-width-2-5@s bdt-flex bdt-flex-middle">
								<?php if ( 'yes' == $settings['show_excerpt'] ) : ?>
									<div class="bdt-slider-excerpt">
										...
										<div class="bdt-slide-counter" data-label="<?php echo str_pad( $slide_index, 2, '0', STR_PAD_LEFT); ?>" >
