...
class Skin_Crelly extends Elementor_Skin_Base {
    ...
    public function render_footer() {
        ...
        ?>
            ...
            <?php $this->parent->render_social_link( 'top', true, ['bdt-flex', 'bdt-flex-middle', 'bdt-margin-large-right', 'bdt-margin-large-bottom', 'bdt-position-bottom-right'] ); ?>
        </div>
        ...
        <div class="bdt-container">
            <div class="bdt-slideshow-content-wrapper">
                <div class="bdt-prime-slider-wrapper">
                        ...
                        <div class="bdt-prime-slider-desc">
                            ...
                            <?php if ($slide_content['title'] && ( 'yes' == $settings['show_title'] )) : ?>
                                <div class="bdt-main-title bdt-text-left">
                                    <h1 bdt-slideshow-parallax="x: 500,0,-100; opacity: 1,1,0">
                    ...
                    <div class="bdt-slider-excerpt-content" bdt-slideshow-parallax="y: 200,0,-100; opacity: 1,1,0">
                        <h3>Overview</h3>
