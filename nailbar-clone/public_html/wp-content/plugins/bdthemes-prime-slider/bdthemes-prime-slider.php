 ...
 * Elementor tested up to: 2.9.7
 *
 * @fs_premium_only /modules/blog/skins/, /modules/general/skins/, /modules/isolate/skins/, /modules/custom/, /modules/woostand/
 */
...
if ( function_exists( 'bdt_ps' ) ) {
    ...
    define( 'BDTPS_CP', '<span class="bdt-widget-badge"></span>' );
