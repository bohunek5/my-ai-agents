    ...
    protected function _register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .bdt-advanced-progress-bar .bdt-progress-item{{CURRENT_ITEM}} ' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        <?php if ($settings['skills_style'] == 'bdt-progress-with-perc') { ?>
            ...
            <?php }?>
                <div class="bdt-progress-level">
                    <div class="bdt-progress-fill "  data-width="<?php echo esc_attr($progress['level']['size']) ?>%">
