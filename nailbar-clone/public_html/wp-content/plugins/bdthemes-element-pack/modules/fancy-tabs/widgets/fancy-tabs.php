...
class Fancy_Tabs extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'tabs_content_height',
			[
				'label' => esc_html__('Content Height', 'bdthemes-prime-slider'),
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-tab-content-wrapper' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-tabs .bdt-fancy-tabs-content .bdt-fancy-tab-title' => 'color: {{VALUE}};',
				],
			]
		);
	...
	public function tabs_content() {
		...
		?>
			...
			<?php foreach ( $settings['tabs'] as $index => $item ) : 
				...
				if ($tab_id    == 'bdt-tab-'. 1 . esc_attr($id)) {
