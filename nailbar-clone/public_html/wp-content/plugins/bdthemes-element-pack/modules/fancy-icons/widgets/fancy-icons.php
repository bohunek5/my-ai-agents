...
class Fancy_Icons extends Widget_Base {
	...
	public function get_icon() {
		return 'bdt-wi-fancy-icons bdt-new';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'title_field' => '{{{ elementor.helpers.renderIcon( this, social_icon, {}, "i", "panel" ) }}} {{{ social_name }}}',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-fancy-icons .bdt-fancy-icons-item:hover a.text'  => 'color: {{VALUE}};',
				],
			]
		);
	...
	public function render() {
		...
		?>
			<div <?php echo ( $this->get_render_attribute_string( 'advanced-icons' ) ); ?> style="background-image: url('<?php echo esc_url( $thumb_url); ?>'); background-attachment: <?php echo esc_attr($settings['background_attachment']) ;?>">
				...
				<div class="bdt-grid bdt-grid-collapse bdt-child-width-1-<?php echo esc_attr($mobile_cols); ?> bdt-child-width-1-<?php echo esc_attr($tablet_cols); ?>@s bdt-child-width-1-<?php echo esc_attr($desktop_cols); ?>@l" bdt-grid>
						...
						<div <?php echo ( $this->get_render_attribute_string( 'share-item' ) ); ?>>
							...
							<a class="<?php echo $item['social_type'] ?>" href="<?php echo esc_url( $item['social_link']['url'] ); ?>">
							<?php endif; ?>
