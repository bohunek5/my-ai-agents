...
class RepeaterField extends BaseFieldManager
{
    ...
    function getComponent()
    {
        return [
            ...
            'settings' => array(
                'label' => __('Repeater Field', 'fluentform'),
                'admin_field_label' => '',
                'container_class' => '',
                'label_placement' => '',
    ...
    public function getEditorCustomizationSettings()
    {
        return [
            'fields_repeat_settings' => array(
                'template' => 'fieldsRepeatSettings',
                'label' => __('Repeat Field Columns', 'fluentform'),
                'help_text' => __('Field Columns which a user will be able to repeat.', 'fluentform'),
            )
        ];
    }
    ...
    public function render($data, $form)
    {
        ...
        <div <?php echo $atts; ?> >
            ...
            <div class='ff-el-input--content'>
                <table data-max_repeat="<?php echo $maxRepeat; ?>" data-root_name="<?php echo $rootName; ?>" class="ff_repeater_table">
                    <thead>
                    <tr>
