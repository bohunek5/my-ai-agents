...
class SmartSlider3Info {
    ...
    public static $version = '3.4.1.3';

    public static $channel = 'stable';

    public static $revision = 'a703876ce9f0b0f5ef3879ddffe6edf8fb8ed2e6';

    public static $revisionShort = 'a703876c';

    public static $branch = 'release-3.4.1.3';
