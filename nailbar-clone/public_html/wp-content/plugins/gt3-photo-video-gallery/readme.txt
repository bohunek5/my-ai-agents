...
<h3>How to Get Pro Version</h3>

You can get Pro version of this plugin directly on our website, click the link below. We offer 50% discount for the first purchase.
...
Yes, Pro version has GT3 photo gallery custom post type with shortcode support. You can create a photo gallery and use its shortcode on any page created with Divi builder.

= Can we use your gallery in Beaver page builder? =
Yes, Pro version has GT3 photo gallery custom post type with shortcode support. You can create a photo gallery and use its shortcode on any page created with Beaver builder.
...
The Pro version has the custom post type gallery which allows you to create a photo or video gallery with the help of shortcode available in the custom post type. You can use it on any page or post.
