...
function gt3pg_wp_enqueue_scripts(){
	...
	wp_enqueue_style('blueimp-gallery.css', GT3PG_PLUGINROOTURL.'/dist/css/deprecated/frontend.css', null, filemtime(GT3PG_PLUGINPATH.'/dist/css/deprecated/frontend.css'));
