...
for page in doc:
    page.insert_font(fontname='freg', fontfile=font_reg_path, set_simple=False)
    page.insert_font(fontname='fbold', fontfile=font_bold_path, set_simple=False)
...
out_dir = '/Users/karolbohdanowicz/.gemini/antigravity-ide/brain/c845d1d1-33ac-44db-b334-e418870bc328/pdf_final_preview'
...
print("Final PDF saved successfully to:", pdf_out_pl)
