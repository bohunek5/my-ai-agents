...
OUT_DIR = "/Users/karolbohdanowicz/my-ai-agents/mazuryaktywnie/out"
...
$old_dirs = [
    'de', 'en', 'css', 'js', 'fonts', 'images', '_next',
    'admin', 'fundusze', 'galeria', 'kontakt', 'oferta', 
    'polityka-prywatnosci', 'reservation', 'rodo', 'stillo',
    'audyt-wcag', 'DamianN'
];
