...
p3_redacts = [
    ...
    # Table labels and values (right edge at 545 to preserve 114 at x=549.9)
    (fitz.Rect(40, 375, 545, 755), (1, 1, 1)),
]
...
for label, val, y in params:
    ...
    rect_val = fitz.Rect(280, y - 15, 545, y + 5)
...
p4_redacts = [
    ...
    # Data rows text (left x starting at 60 to avoid touching page number 115 at x=34.7)
...
tmp_out = '/tmp/translated_master_prescot.pdf'
doc.save(tmp_out)
...
out_dir = '/Users/karolbohdanowicz/.gemini/antigravity-ide/brain/c845d1d1-33ac-44db-b334-e418870bc328/pdf_master_preview'
...
print("Master PDF translation complete!")
