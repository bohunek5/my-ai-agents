...
# Save directly to the original file in Downloads as well, as requested by user ("w miejsca ramek po polsku")
doc.save('/tmp/translated_prescot.pdf')

import shutil
shutil.copy('/tmp/translated_prescot.pdf', pdf_out_orig)
shutil.copy('/tmp/translated_prescot.pdf', pdf_out_pl)

# Render previews for visual verification
out_dir = '/Users/karolbohdanowicz/.gemini/antigravity-ide/brain/c845d1d1-33ac-44db-b334-e418870bc328/pdf_final_working_preview'
...
print("SUCCESSFULLY COMPLETED! File written to both Downloads files.")
