...
const translations = {
  ...
  en: {
    ...
    footerTerms: "Regulations",
    footerPrivacy: "Privacy Policy",
    footerCookies: "Cookie settings",
    contactTitle: "Book an appointment or ask about a treatment",
    contactPageLead: "The easiest way is Booksy. For current affairs you can also use Facebook or Google Maps.",
    contactCardTitle: "Contact details",
    contactBookingLabel: "Booking",
    contactPhoneLabel: "Phone",
    contactAddressLabel: "Address",
    contactMessageLabel: "Message",
    contactSocialLabel: "Social",
    tourHeroTitle: "See the NailBar salon in 360°",
    tourHeroLead: "Drag the view with your finger or mouse, use the arrows or start an automatic rotation.",
    euHeroEyebrow: "EU Projects",
    euHeroTitle: "Information about funding",
    euHeroLead: "The site contains required markings and information about the project carried out with the support of European Funds.",
    euProjectInfoTitle: "Project details",
    euBeneficiaryLabel: "Beneficiary",
    euProjectTitleLabel: "Project title",
    euProjectTitleVal: "“Securing business continuity of Nailbar Małgorzata Marchelewicz during the epidemic”",
    euProjectDescLabel: "Description and goals",
    euProjectDescVal: "The project goal is to develop and implement measures securing business continuity of Nailbar Małgorzata Marchelewicz during the epidemic, building the company's resilience to future crises.",
    euInfoLabel: "Information",
    euInfoVal: "Funded as part of the Union's response to the COVID-19 pandemic.",
    euAmountsTitle: "Amounts",
    euValueLabel: "Project value",
    euContributionLabel: "European Funds contribution",
    euMarkingsTitle: "Object markings",
    euMarking1: "European Funds sign,",
    euMarking2: "colors of the Republic of Poland,",
    euMarking3: "official promotional logo of the voivodeship and the European Union sign,",
    euMarking4: "information about financing as part of the Union's response to the COVID-19 pandemic."
  },
  de: {
    ...
    contactTitle: "Termin buchen oder nach einer Behandlung fragen",
    contactPageLead: "Am einfachsten über Booksy. Für aktuelle Angelegenheiten können Sie auch Facebook oder Google Maps nutzen.",
    contactCardTitle: "Kontaktdaten",
    contactBookingLabel: "Buchung",
    contactPhoneLabel: "Telefon",
    contactAddressLabel: "Adresse",
    contactMessageLabel: "Nachricht",
    contactSocialLabel: "Social",
    tourHeroTitle: "Sehen Sie den NailBar-Salon in 360°",
    tourHeroLead: "Ziehen Sie die Ansicht mit dem Finger oder der Maus, nutzen Sie die Pfeile oder starten Sie die automatische Drehung.",
    euHeroEyebrow: "EU-Projekte",
    euHeroTitle: "Informationen zur Förderung",
    euHeroLead: "Die Seite enthält die erforderlichen Kennzeichnungen und Informationen über das mit Unterstützung der Europäischen Fonds durchgeführte Projekt.",
    euProjectInfoTitle: "Projektdetails",
    euBeneficiaryLabel: "Begünstigter",
    euProjectTitleLabel: "Projekttitel",
    euProjectTitleVal: "„Sicherung der Kontinuität der Geschäftstätigkeit der firma Nailbar Małgorzata Marchelewicz während der Epidemie“",
    euProjectDescLabel: "Beschreibung und Ziele",
    euProjectDescVal: "Ziel des Projekts ist die Ausarbeitung und Umsetzung von Maßnahmen zur Sicherung der Kontinuität der Geschäftstätigkeit der Firma Nailbar Małgorzata Marchelewicz während der Epidemie, um die Widerstandsfähigkeit des Unternehmens gegen künftige Krisen zu stärken.",
    euInfoLabel: "Information",
    euInfoVal: "Finanziert als Teil der Reaktion der Union auf die COVID-19-Pandemie.",
    euAmountsTitle: "Beträge",
    euValueLabel: "Projektwert",
    euContributionLabel: "Beitrag der Europäischen Fonds",
    euMarkingsTitle: "Kennzeichnungen",
    euMarking1: "Zeichen der Europäischen Fonds,",
    euMarking2: "Farben der Republik Polen,",
    euMarking3: "offizielles Werbelogo der Woiwodschaft und Zeichen der Europäischen Union,",
    euMarking4: "Informationen zur Finanzierung als Teil der Reaktion der Union auf die COVID-19-Pandemie."
  }
};
...
function rememberOriginals() {
  ...
  $$("[data-i18n-aria-label]").forEach(element => originalText.set(`aria-label:${element.dataset.i18nAriaLabel}`, element.getAttribute("aria-label") || ""));
}
...
function applyLanguage() {
  ...
  $$("[data-i18n-aria-label]").forEach(element => {
    ...
    const fallback = originalText.get(`aria-label:${key}`) || element.getAttribute("aria-label") || "";
    element.setAttribute("aria-label", translateValue(key, fallback));
  });
  ...
  window.dispatchEvent(new CustomEvent("nailbar-language-changed", { detail: language }));
}
...
$$(".lang-button").forEach(button => button.addEventListener("click", () => {
  ...
  applyLanguage();
  if (typeof applyStoreLanguage === "function") {
    storeLanguage = language;
    applyStoreLanguage();
  }
  if (typeof applyCaseLanguage === "function") {
...
$("#accessibilityOpen")?.addEventListener("click", () => { if (accessPanel) accessPanel.hidden = false; });
$("#accessibilityClose")?.addEventListener("click", () => { if (accessPanel) accessPanel.hidden = true; });
...
const revealTargets = $$(".section, .newsletter, .contact-section, .tour-section, .subpage-hero, .contact-page");
