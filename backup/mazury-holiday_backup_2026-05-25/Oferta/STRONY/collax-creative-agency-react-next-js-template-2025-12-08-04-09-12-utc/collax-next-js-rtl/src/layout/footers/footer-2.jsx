          ...
          <div className="row">
            <div className="col-xl-12 wow tpfadeUp" data-wow-duration=".3s" data-wow-delay=".5s">
              <div className="footer-widget-info text-center">
                ...
                <p>{text}</p>
                <Link className="tp-btn mb-50" href="/contact">
                  {btn_text}
                </Link>
          ...
          <div className="tp-copyright-bottom wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".7s">
            <div className="row align-items-center">
              <div className="col-xl-4 col-lg-4 col-md-12 col-12">
                <div className="tp-copyright-logo-box text-md-center text-center text-lg-end mb-30">
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div className="tp-cpoyright-menu text-md-end text-center text-lg-center mb-30">
                  {copy_right_menu.map((m, i) => <a key={i} href="#">{m}</a>)}
                </div>
              </div>
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div className="tp-copyright-social tp-copyright-social-two text-center text-lg-start mb-30">
                  {social_links.map((s, i) => (
                    <Link key={i} href={s.link} target="_blank" rel="noreferrer"><i className={s.icon}></i></Link>
                  ))}
                </div>
              </div>
            </div>
