...
const CtaTwo = () => {
  return (
    <div
      className="tp-news-letter-area tp-news-letter-bg pt-65 pb-60"
          ...
          <div className="col-xl-7 col-lg-7 col-md-12 ">
            <div className="tp-news-sub-wrapper pr-50">
              <div className="tp-news-letter-section-box">
                <h5
                  className="tp-subtitle subtitle-secondary-color wow tpfadeUp"
              ...
              <div
                ...
                data-wow-delay="1s"
              >
                <Link className="tp-btn-lg-yellow mr-20" href="/contact">
                  Become a Partner
                </Link>
                <Link className="tp-btn-sky" href="/about-me">
                  Press Office
                </Link>
              </div>
            </div>
