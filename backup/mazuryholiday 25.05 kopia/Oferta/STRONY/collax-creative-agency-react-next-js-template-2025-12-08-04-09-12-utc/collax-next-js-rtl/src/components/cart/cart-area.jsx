...
import { add_cart_product, clear_cart, decrease_quantity, get_cart_products, remove_cart_product } 
        ...
        <div className="container">
          {cartItems.length === 0 &&
            <div className='text-center'>
              ...
              <Link className="tp-btn mt-15" href={'/product'}>Return to shop</Link>
            </div>
          }
