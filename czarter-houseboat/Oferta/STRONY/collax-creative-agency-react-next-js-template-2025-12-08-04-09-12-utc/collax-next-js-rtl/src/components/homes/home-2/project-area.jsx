...
const project_contents = {
  ...
  title: "Creative work.",
  shapes: [
    { num: "one", img: "project-shape-2.png" },
    { num: "two", img: "project-shape-3.png" },
  ],
  project_items: [
...
const ProjectArea = () => {
  ...
  // category_items
  const category_items = project_items.filter(
  ...
  return (
    <div className="tp-project-area pt-120 pb-120 p-relative">
      {shapes.map((s, i) => (
        <div key={i} className={`tp-project-shape-${s.num}`}>
        ...
        <div className="row grid gx-45">
          <PhotoProviderWrapper>
            {portfolioItems.map((item, i) => (
              <div
                key={i}
                className="col-xxl-6 col-xl-6 col-lg-6 col-md-6  grid-item cat2 cat3"
              >
