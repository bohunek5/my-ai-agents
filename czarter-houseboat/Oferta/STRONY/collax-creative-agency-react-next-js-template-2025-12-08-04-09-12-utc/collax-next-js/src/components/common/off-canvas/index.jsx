      ...
      <div className="tp-offcanvas-area">
        <div className={`tpoffcanvas ${isOpen ? 'opened' : ''}`}>
          ...
          <div className="tpoffcanvas__contact">
            ...
            <ul>
              <li>
                <i className="fas fa-star"></i> <Link href="https://goo.gl/maps/abHegV4AoiJA6Syd8" rel="noreferrer" target="_blank">Melbone st, Australia, Ny 12099</Link>
              </li>
              <li><i className="fas fa-star"></i><Link href="tel:8180012345678">+81 800 123 456 78</Link></li>
              <li><i className="fas fa-star"></i><Link href="mailto:Collaxmail@gmail.com">Collaxmail@gmail.com</Link></li>
            </ul>
          </div>
          ...
          <div className="tpoffcanvas__instagram d-none d-sm-block">
            ...
            <div className="tp-insta">
              <div className="row">
                {inst_imgs.map((img, i) => (
                  <div key={i} className="col-3 col-sm-3"><Link href="#">
