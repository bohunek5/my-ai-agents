          ...
          <div className="row">
            ...
            <div className="col-xl-2 col-lg-2 col-md-2 col-12">
              <div className="cd-social-icon">
                <Link className="cd-si-color-1" href="#"><i className="fab fa-facebook-f"></i></Link>
                <Link className="cd-si-color-2" href="#"><i className="fab fa-pinterest-p"></i></Link>
                <Link className="cd-si-color-3" href="#"><i className="fab fa-twitter"></i></Link>
              </div>
            </div>
          </div>
        </div>
