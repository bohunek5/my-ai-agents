...
TARGET_IMAGES_DIR = os.path.join(OUT_DIR, "images/pokoje_fuleda")
ZIP_PATH = "/Users/karolbohdanowicz/my-ai-agents/mazury-holiday/deploy_pokoje_images.zip"

print(f"📦 Zipping {TARGET_IMAGES_DIR} to {ZIP_PATH}...")
