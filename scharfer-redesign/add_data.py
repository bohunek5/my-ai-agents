...
file_path = "/Users/karolbohdanowicz/my-ai-agents/scharfer-redesign/src/data/scharferData.ts"

with open(file_path, 'r') as f:
    content = f.read()

pl_inject = """    feature1Title: 'Aluminiowa Obudowa',
...
en_inject = """    feature1Title: 'Aluminum Casing',
...
de_inject = """    feature1Title: 'Aluminiumgehäuse',
...
lt_inject = """    feature1Title: 'Aliuminio Korpusas',
...
# Replace in pl
content = re.sub(r"('contactError': 'Wystąpił błąd podczas wysyłania wiadomości. Spróbuj ponownie.',?\s*)", r"\g<1>\n" + pl_inject, content)

# Replace in en
content = re.sub(r"('contactError': 'An error occurred while sending the message. Please try again.',?\s*)", r"\g<1>\n" + en_inject, content)

# Replace in de
content = re.sub(r"('contactError': 'Beim Senden der Nachricht ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',?\s*)", r"\g<1>\n" + de_inject, content)

# Replace in lt
content = re.sub(r"('contactError': 'Siunčiant žinutę įvyko klaida. Bandykite dar kartą.',?\s*)", r"\g<1>\n" + lt_inject, content)

with open(file_path, 'w') as f:
    f.write(content)

print("Injected feature texts into scharferData.ts")
