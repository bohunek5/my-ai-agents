    ...
    <header className="site-header">
      <div className="header-inner">
        ...
        <div className="header-actions" style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          {/* Retail link */}
          <a href="https://www.prescot.com.pl/pl/c/Zasilacze-LED-Scharfer/580" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '0.4rem 0.8rem', border: '1px solid #eaeaea', background: '#fafafa', color: '#444', textDecoration: 'none', borderRadius: '6px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', transition: 'all 0.3s', whiteSpace: 'nowrap' }}>
          ...
          {/* Language Dropdown */}
          <div className={`language-dropdown ${dropdownOpen ? 'open' : ''}`} style={{ position: 'relative', marginRight: '1.5rem', marginLeft: '0.5rem' }}>
          ...
          {/* Sticky CTA for CRO */}
          <Link href="/kontakt" className="btn-primary" id="cta-distributor-btn" style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '0.6rem 1.2rem', fontSize: '0.85rem', backgroundColor: 'var(--c-primary)', color: 'white', textDecoration: 'none', borderRadius: '4px', fontWeight: 600 }}>
