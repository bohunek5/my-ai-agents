  ...
  return (
    <div className="product-card" style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '1.2rem', position: 'relative', alignItems: 'stretch' }}>
      ...
      <div style={{ display: 'flex', gap: '0.3rem', flexWrap: 'nowrap', marginBottom: '1rem', zIndex: 5 }}>
        ...
        <span style={{ backgroundColor: 'var(--c-heading)', color: 'var(--c-white)', padding: '0.15rem 0.4rem', fontSize: '0.65rem', fontWeight: 800, borderRadius: '4px', whiteSpace: 'nowrap' }}>IP67</span>
        <span style={{ backgroundColor: 'var(--c-light-gray)', border: '1px solid var(--c-border)', color: 'var(--c-text)', padding: '0.15rem 0.4rem', fontSize: '0.65rem', fontWeight: 800, borderRadius: '4px', whiteSpace: 'nowrap' }}>SELV</span>
        <span style={{ backgroundColor: 'var(--c-light-gray)', border: '1px solid var(--c-border)', color: 'var(--c-text)', padding: '0.15rem 0.4rem', fontSize: '0.65rem', fontWeight: 800, borderRadius: '4px', whiteSpace: 'nowrap' }}>CE</span>
        <span style={{ backgroundColor: 'var(--c-light-gray)', border: '1px solid var(--c-border)', color: 'var(--c-text)', padding: '0.15rem 0.4rem', fontSize: '0.65rem', fontWeight: 800, borderRadius: '4px', whiteSpace: 'nowrap' }}>RoHS</span>
        <span style={{ backgroundColor: 'var(--card-bg)', border: '1px solid var(--c-red)', color: 'var(--c-red)', padding: '0.15rem 0.4rem', fontSize: '0.65rem', fontWeight: 800, borderRadius: '4px', whiteSpace: 'nowrap' }}>{t('specWarrantyValShort')}</span>
      </div>
      ...
      <div style={{ background: 'var(--c-light-gray)', border: '1px solid var(--c-border)', borderRadius: '10px', padding: '0.8rem 1rem', marginBottom: '1.2rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
...
function ProductModal({ product, onClose }: { product: Product; onClose: () => void }) {
  ...
  return (
    <div className="product-modal active" id="product-modal" onClick={(e) => { if ((e.target as HTMLElement).id === 'product-modal') onClose(); }} style={{ display: 'flex', position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.6)', zIndex: 10000, alignItems: 'center', justifyContent: 'center' }}>
      <div className="modal-content" style={{ maxWidth: '1000px', maxHeight: '92vh', overflowY: 'auto', background: 'var(--card-bg)', borderRadius: '16px', padding: '3.5rem', position: 'relative', display: 'flex', gap: '3.5rem', flexWrap: 'wrap', width: '95%', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.25)', border: '1px solid var(--c-border)' }}>
        ...
        <div className="modal-info-col" style={{ flex: 1.3, minWidth: '320px', display: 'flex', flexDirection: 'column' }}>
          ...
          <table className="modal-specs-table" style={{ width: '100%', borderCollapse: 'collapse', fontSize: '1rem', marginBottom: '2.5rem' }}>
            <tbody>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specVolt')}</td><td style={{ padding: '0.9rem 0', fontWeight: 700, color: 'var(--c-heading)' }}>{product.specs.voltage} DC</td></tr>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specCurrent')}</td><td style={{ padding: '0.9rem 0', fontWeight: 700, color: 'var(--c-heading)' }}>{product.specs.current}</td></tr>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specPowerNom')}</td><td style={{ padding: '0.9rem 0', fontWeight: 700, color: 'var(--c-heading)' }}>{product.name.match(/\d+W/) ? product.name.match(/\d+W/)?.[0] : ''}</td></tr>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specEan')}</td><td style={{ padding: '0.9rem 0', fontWeight: 700, color: 'var(--c-heading)' }}>{product.ean}</td></tr>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specDimFull')}</td><td style={{ padding: '0.9rem 0', fontWeight: 700, color: 'var(--c-heading)' }}>{product.specs.dim}</td></tr>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specIp')}</td><td style={{ padding: '0.9rem 0', fontWeight: 800, color: 'var(--c-red)' }}>{t('specIpVal')}</td></tr>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specProtect')}</td><td style={{ padding: '0.9rem 0', fontWeight: 600, color: '#10b981', fontSize: '0.9rem' }}>{t('specProtectVal')}</td></tr>
              <tr style={{ borderBottom: '1px solid var(--c-border)' }}><td style={{ padding: '0.9rem 0', color: 'var(--c-text)', fontWeight: 500 }}>{t('specWarranty')}</td><td style={{ padding: '0.9rem 0', fontWeight: 800, color: 'var(--c-red)' }}>{t('specWarrantyVal')}</td></tr>
            </tbody>
          </table>
          ...
          <div className="modal-actions" style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
            ...
            <button onClick={onClose} className="btn-secondary" style={{ padding: '1rem', borderRadius: '8px', fontWeight: 600, border: '1px solid #ddd', color: 'var(--c-text)' }}>
              {t('backToCatalog')}
            </button>
          </div>
        </div>
