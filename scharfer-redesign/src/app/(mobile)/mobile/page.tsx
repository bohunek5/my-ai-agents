      ...
      <main className="mobile-main">
          ...
          <section className="view-section active">
            ...
            <div className="container" style={{ padding: '20px 15px' }}>
              <div className="b2b-story-section-m" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                ...
                <div className="b2b-story-card-m" style={{ background: 'var(--card-bg)', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--c-border)', boxShadow: '0 4px 10px rgba(0,0,0,0.02)' }}>
                  <img src="/assets/40012.webp" alt="Zabezpieczenia" style={{ width: '100%', height: 'auto', display: 'block', borderRadius: '8px' }} />
                  <div style={{ padding: '20px' }}>
        ...
        {activeTab === 'oferta' && (
          <section className="view-section active">
            ...
            {/* Unified Mobile Hero for Oferta */}
            <div style={{ position: 'relative', width: '100%', padding: '45px 20px', textAlign: 'center', overflow: 'hidden', borderBottom: '1px solid var(--c-border)', backgroundImage: 'url("/assets/scharfer_supplies_hero.webp")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        {activeTab === 'info' && (
          <section className="view-section active">
            {/* Unified Page Hero */}
            <div className="hero-m-unified" style={{ position: 'relative', width: '100%', padding: '45px 20px', textAlign: 'center', overflow: 'hidden', borderBottom: '1px solid var(--c-border)', backgroundImage: 'url("/assets/scharfer_estate_night.webp")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
              <div className="page-hero-overlay" style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(255, 255, 255, 0.88)', zIndex: 1 }} />
            ...
            <div className="container" style={{ padding: '20px 15px' }}>
              ...
              <div className="b2b-story-section-m" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                ...
                <div className="b2b-story-card-m" style={{ background: 'var(--card-bg)', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--c-border)', boxShadow: '0 4px 10px rgba(0,0,0,0.02)' }}>
                  <img src="/assets/40012.webp" alt="Zabezpieczenia" style={{ width: '100%', height: '180px', objectFit: 'cover' }} />
                  <div style={{ padding: '20px' }}>
                    <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--c-heading)', marginBottom: '8px' }}>{t('story5Title')}</h3>
                    <p style={{ fontSize: '0.85rem', color: 'var(--c-text)', lineHeight: 1.5, marginBottom: '8px' }}>{t('story5P1')}</p>
                    <ul style={{ listStyleType: 'disc', paddingLeft: '15px', margin: '0 0 10px 0', fontSize: '0.82rem', color: 'var(--c-text)', lineHeight: 1.4 }}>
        ...
        {activeTab === 'kontakt' && (
          <section className="view-section active">
            {/* Unified Page Hero */}
            <div style={{ position: 'relative', width: '100%', padding: '45px 20px', textAlign: 'center', overflow: 'hidden', borderBottom: '1px solid var(--c-border)', backgroundImage: 'url("/assets/kontakt_hero.webp")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
              <div className="page-hero-overlay" style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(255, 255, 255, 0.88)', zIndex: 1 }} />
              <div style={{ position: 'relative', zIndex: 3 }}>
