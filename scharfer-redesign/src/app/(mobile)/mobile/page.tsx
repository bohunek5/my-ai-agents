            ...
            <div className="hero-m" style={{ position: 'relative', overflow: 'hidden', padding: '3rem 1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '360px', background: '#000', color: 'white' }}>
              ...
              <div className="hero-content" style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: '100%' }}>
                <h1 className="hero-title" style={{ fontSize: '1.65rem', fontWeight: 800, color: '#fff', marginBottom: '12px', lineHeight: 1.2 }}>
                  7 Lat gwarancji.<br />Stabilne Zasilanie.<br />Prawdziwe <span style={{ color: 'var(--c-primary)' }}>100%</span> mocy.
                </h1>
                <p className="hero-subtitle" style={{ fontSize: '0.85rem', color: '#ccc', marginBottom: '20px', lineHeight: 1.45 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '25px' }}>
                  <button onClick={() => handleTabChange('oferta')} className="btn-primary" style={{ border: 'none', padding: '12px', borderRadius: '6px', fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer', background: 'var(--c-primary)', color: 'white' }}>
                    Zobacz Katalog Zasilaczy
                  </button>
                  <button onClick={() => handleTabChange('kontakt')} className="btn-secondary" style={{ padding: '12px', borderRadius: '6px', fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer', background: 'rgba(255,255,255,0.15)', border: '1px solid rgba(255,255,255,0.3)', color: 'white' }}>
                    Współpraca B2B
                  </button>
                </div>

                <div className="hero-trust" style={{ display: 'flex', justifyContent: 'space-around', gap: '8px' }}>
